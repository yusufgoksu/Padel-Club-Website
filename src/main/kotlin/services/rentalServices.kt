...
object RentalServices {
    ...
    fun getAvailableHours(clubId: Int, courtId: Int, date: String): List<Int> {
        ...
        return RentalDataDb.getAvailableRentalHours(clubId, courtId, date)
            .mapNotNull {
                try {
                    java.time.LocalDateTime.parse(it, formatter).hour
                } catch (e: Exception) {
                    null
                }
            }
    ...
    fun usersWithCountsByCourt(courtId: Int): List<Pair<Int, Int>> =
